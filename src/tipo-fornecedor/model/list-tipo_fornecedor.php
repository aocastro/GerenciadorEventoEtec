<?php
    ...
    $sql = "SELECT idTipoFornecedor, nomeTipoFornecedor FROM tipo_fornecedor WHERE 1=1 ";
    ...
    if( !empty( $filtro ) ){
        ...
        $sql .= " AND (idTipoFornecedor LIKE '$filtro%' ";
        $sql .= " OR nomeTipoFornecedor LIKE '$filtro%') ";
    }
